...
type NewJobPayload = Omit<Jobitem, 'id'>

const AddJobPage = () => {
  const navigate = useNavigate()

  // --- Replaced by native FormData in React 19 form action ---
  ...
  // --- Previous event-driven submission ---
  // const submitForm = async (e: FormEvent<HTMLFormElement>) => {
  //   e.preventDefault()
  //   ...
  // }

  // React 19 Form Action: Receives native FormData directly
      ...
      <section className="bg-indigo-50">
        <div className="container m-auto max-w-2xl py-24">
          <div className="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
            {/* React 19 form action attribute */}
